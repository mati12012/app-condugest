...
const RegistrarProfesor = ({ cambiarVista }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (datos.sede.trim() === '') {
      setMensaje('Error: La sede es obligatoria');
      setCargando(false);
      return;
    }
  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-slate-200">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <label className="block text-sm font-semibold text-slate-700 mb-2">Correo personal</label>
          <input
            type="email"
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-2">Licencia Autorizada</label>
            <select
